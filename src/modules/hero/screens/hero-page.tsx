          ...
          <div className="flex-1 flex flex-col items-start max-w-xl">
            ...
            <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.88, ease: EASE_PREMIUM }} className="flex flex-wrap gap-3 mb-8">
              ...
              <motion.button
                ...
                whileHover={{ borderColor: 'rgba(0,212,255,0.55)', color: 'var(--color-accent)' }}
                whileTap={{ scale: 0.96 }} transition={{ type: 'spring', stiffness: 420, damping: 26 }}
                className="px-8 py-3.5 rounded-lg font-display font-bold text-sm tracking-wider border text-[--color-text-secondary] transition-colors"
                style={{ borderColor: 'var(--color-border)' }}
              >METHODOLOGY</motion.button>
            </motion.div>
